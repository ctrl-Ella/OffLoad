...
const exampleEvents: Record<number, CalendarEvent[]> = {
  1: [{ time: "09:00", title: "Start of the week", detail: "Elvia and Carlos · Family plan", tone: "accent" }],
  2: [{ time: "17:00", title: "Pick up Nicolas", detail: "Carlos · School", tone: "alert" }],
  3: [{ time: "18:30", title: "Time for yourself", detail: "Elvia · Walk", tone: "neutral" }],
  4: [{ time: "17:00", title: "Pick up Nicolas", detail: "Still to coordinate", tone: "alert" }],
  5: [{ time: "16:30", title: "Weekend plans", detail: "Family · To be confirmed", tone: "accent" }],
  6: [{ time: "11:30", title: "Nicolas's match", detail: "Carlos · Sports centre", tone: "alert" }, { time: "17:00", title: "Coffee and your book", detail: "Elvia · Personal time", tone: "neutral" }],
  0: [{ time: "10:00", title: "Family breakfast", detail: "A relaxed start", tone: "accent" }],
};
